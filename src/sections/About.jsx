          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                ...
                reliable and scalable products with the best user experience.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">I&apos;m based in Santa Cruz, Bolivia and open to remote work worldwide.</p>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">gamartinezayala@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
